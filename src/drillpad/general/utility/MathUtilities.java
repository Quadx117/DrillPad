...
public class MathUtilities
{
     ...
     *
     * @param value1  The coordinate on one axis of vertex 1 of the defining
     *                triangle.
     * @param value2  The coordinate on the same axis of vertex 2 of the
     *                defining triangle.
     * @param value3  The coordinate on the same axis of vertex 3 of the
     *                defining triangle.
     * @param amount1 The normalized barycentric (areal) coordinate b2, equal to
     *                the weighting factor for vertex 2, the coordinate of which
     *                is specified in value2.
     * @param amount2 The normalized barycentric (areal) coordinate b3, equal to
     *                the weighting factor for vertex 3, the coordinate of which
     *                is specified in value3.
     ...
     * @param min   The minimum value. If {@code value} is less than
     *              {@code min}, {@code min} will be returned.
     * @param max   The maximum value. If {@code value} is greater than
     ...
     */
    public static float hermite(float value1, float tangent1,
                                float value2, float tangent2, float amount)
    {
     ...
     * Passing amount a value of 0 will cause value1 to be returned,
     ...
     * This method performs the linear interpolation based on the following
     * formula :
     * {@code (1 - amount) * value1 + amount * value2}
     * Passing amount a value of 0 will cause value1 to be returned,
     * a value of 1 will cause value2 to be returned.
     * <p>
     * This version is more precise with floating point numbers but may take
     * longer to execute
     *
     * @see
    ...
    public static float smoothStep(float value1, float value2, float amount)
    {
        ...
        float result = MathUtilities.clamp(amount, 0f, 1f);
        result = MathUtilities.hermite(value1, 0f, value2, 0f, result);
     ...
     *
     * @param value A value.
     * @return {@code true} if {@code value} is powered by two;
     ...
     * @param origin   The rotation origin or "axis".
